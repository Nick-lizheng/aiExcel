...
public class ExcelModifier28 {

    public static void main(String[] args) {
        String inputFilePath = "./excel_file/latest_10min_wind.xlsx";
        String outputFilePath = "./excel_file/output4.xlsx";
        ...
        try (FileInputStream fis = new FileInputStream(inputFilePath);
            ...
            String[] newColumns = {"Wind Speed Category", "Gust Speed Category", "Average Wind Speed", "New Column"};
            ...
            for (Row row : sheet) {
                ...
                Cell newColumnCell = row.createCell(lastColumnIndex + 3);
                ...
                // New Column
                if (meanSpeed < 10) {
                    newColumnCell.setCellValue(0);
                } else if (meanSpeed > 10) {
                    newColumnCell.setCellValue(1);
                } else if (meanSpeed == 10) {
                    newColumnCell.setCellValue(meanSpeed * 100);
                }
            }
