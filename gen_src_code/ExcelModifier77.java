...
public class ExcelModifier77 {

    public static void main(String[] args) {
        String inputFilePath = "./excel_file/latest_10min_wind.xlsx";
        String outputFilePath = "./excel_file/output17.xlsx";
        ...
        try (FileInputStream fis = new FileInputStream(inputFilePath);
            ...
            for (Row row : sheet) {
                ...
                if (lastColumnCell != null && lastColumnCell.getCellType() != CellType.BLANK) {
                    ...
                    // Handle N/A values
                    if (lastColumnCell.getCellType() == CellType.STRING && "N/A".equals(lastColumnCell.getStringCellValue())) {
                        value = 0;
                    } else if (lastColumnCell.getCellType() == CellType.STRING && "".equals(lastColumnCell.getStringCellValue().trim())) {
                        value = 0;
                    } else {
